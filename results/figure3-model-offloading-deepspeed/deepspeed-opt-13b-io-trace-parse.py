...
figure_save_dir = 'deepspeed-model-figures/deepspeed-mode-opt-13b-bs-{}-{}'
...
deepspeed_file = os.path.join(result_dir, results_file_deepspeed)
...
if True:
    ...
    group_list = ['write']
    y_values = {'write': io_size_by_sec['WS']['size']}
    y_values['write'] = [x / 1024 for x in y_values['write']]
    std_dev = None
    # x_ticks = ['xtick_1', 'xtick_1']
    legend_label = None
...
#     plt.scatter(x, y, c='blue', alpha=0.6, edgecolors='w', s=100)
