...
# nohup python3 flexgen-opt30b-model-trace-block.py --bs 1 --fs ext4 --run > flexgen-opt30b-model-trace-block-bs-1-log.txt 2>&1 &

OFFLOAD_DIR = '/mnt/nvmevirt/flexgen-offload'
FLEXGEN_CMD = f'sudo systemd-run --scope --property=MemoryLimit=10G /home/z_ren/anaconda3/envs/flexgen/bin/python3 -m flexllmgen.flex_opt --model facebook/opt-30b --path _DUMMY_ --offload-dir {OFFLOAD_DIR} --prompt-len 256 --gen-len 32 --num-gpu-batches 1 --percent 0 0 100 0 100 0'
